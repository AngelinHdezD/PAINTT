...
namespace PAINT
{
    public partial class Form1 : Form
    {
        ...
        private void txtPapel_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            sX= ix - cX;
            sY= iy - cY;
            if (chBoxReal.Checked)
            {
                //LINEA
                if (chBoxReal.Checked && chBox1.Checked)
                {

                    papel.DrawLine(pen, cX, cY, sX, sY);
                }
                //ELIPSE
                if (chBoxReal.Checked && chBox2.Checked)
                {
                ...
                //ELIPSE RELLENO
                if (chBoxReal.Checked && chBox3.Checked)
                {

                    papel.FillEllipse(relleno, cX, cY, sX, sY);
                }
                //CUADRADO
                if (chBoxReal.Checked && chBox4.Checked)
                {

                    papel.DrawRectangle(pen, cX, cY, sX, sY);
                }
                //RECTANGULO
                if (chBoxReal.Checked && chBox5.Checked)
                {
                    papel.DrawLine(pen, cX, cY, sX, sY);
                    papel.DrawRectangle(pen, cX, cY, sX, sY);
                }
